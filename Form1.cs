...
namespace PointAndRectangle
{
    public partial class FormPointAndRectangle : Form
    {
        ...
        {
            Draw(); //метод в който е всичко за показването в кутията
        }
        ...
        private void Draw()
        {
            ...
            // Взима кординатите на правоъгълника и точката от Form
            ...
            // Показва местоположението на точката дали ще е Вътре/Вън или на рамката на правоъгълника
            ...
            // Изчислява кординатите на правоъгълника
            ...
            // Изчислява кординатите на точката
            ...
            // Показва/нарисува правоъгълника и точката
            ...
            using (var g = Graphics.FromImage(pictureBox.Image))
            {
                ...
                // Показва правоъгълника (в размерите на кутията)
                var pen = new Pen(Color.Blue, 3);
                g.DrawRectangle(pen, rect);

                // Същото но за точката ^
